...
`is.na(NA)` $\Rightarrow$ `r is.na(NA)`

`as.logical(TRUE+TRUE)` $\Rightarrow$ `r as.logical(TRUE+TRUE)`

`TRUE==TRUE` $\Rightarrow$ `r TRUE==TRUE`

`TRUE+FALSE` $\Rightarrow$ `r TRUE+FALSE`
