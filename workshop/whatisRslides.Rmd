...
Because vectors, matrices, and data frames store your "data", they also have a special name called "data objects" even though values that are not data frames are commonly referred to as just atomic vectors
