...
3. Using the following code [copy and paste on to your console] to obtain a data frame called `ps1.csv` provided by me, then tell me how many `NA`'s are there in this data frame. (Hint: you can sum up a vector using `sum()`)

`read.csv("https://willythewoo.github.io/WillyTheWoo/workshop/data/ps1.csv")`


# That is the end of the first workshop! I'll see you in the second!